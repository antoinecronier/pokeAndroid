/**************************************************************************
 * PokePokemonTestDBBase.java, pokebattle Android
 *
 * Copyright 2016
 * Description : 
 * Author(s)   : Harmony
 ...
 */
public abstract class PokePokemonTestDBBase extends TestDBBase {
    ...
    public void testCreate() {
        ...
        if (this.entity != null) {
            ...
            result = (int)this.adapter.insert(pokePokemon);
    ...
    public void testUpdate() {
        ...
        if (this.entity != null) {
            ...
            result = (int) this.adapter.update(pokePokemon);
