/**************************************************************************
 * PokeNpcTestWSBase.java, pokebattle Android
 *
 * Copyright 2016
 * Description : 
 * Author(s)   : Harmony
...
import com.antoinecronier.pokebattle.data.PokeNpcWebServiceClientAdapter;
...
import com.antoinecronier.pokebattle.test.utils.PokeNpcUtils;
...
/** PokeNpc Web Service Test.
 * 
 * @see android.app.Fragment
 */
public abstract class PokeNpcTestWSBase extends TestWSBase {
    /** model {@link PokeNpc}. */
    protected PokeNpc model;
    /** web {@link PokeNpcWebServiceClientAdapter}. */
    protected PokeNpcWebServiceClientAdapter web;
    /** entities ArrayList<PokeNpc>. */
    ...
    protected void setUp() throws Exception {
        ...
        this.web = new PokeNpcWebServiceClientAdapter(
    ...
    public void testGetAll() {
        this.server.enqueue(new MockResponse().setBody("{PokeNpcs :"
            + this.web.itemsToJson(this.entities).toString() + "}"));

        ArrayList<PokeNpc> pokeNpcList = 
                new ArrayList<PokeNpc>();

        int result = this.web.getAll(pokeNpcList);

        Assert.assertEquals(pokeNpcList.size(), this.entities.size());
    }
    ...
    public void testUpdate() {
        ...
        PokeNpcUtils.equals(this.model, item);
    }
