/**************************************************************************
 * PokePositionTestProviderBase.java, pokebattle Android
 *
 * Copyright 2016
 * Description : 
 * Author(s)   : Harmony
 ...
 */
public abstract class PokePositionTestProviderBase extends TestDBBase {
    ...
    protected PokePositionProviderUtils providerUtils;
    ...
    protected void setUp() throws Exception {
        ...
        this.providerUtils = new PokePositionProviderUtils(this.getContext());
    }
    ...
    public void testCreate() {
        ...
        if (this.entity != null) {
            ...
            try {
                ContentValues values = PokePositionContract.itemToContentValues(pokePosition);
                values.remove(PokePositionContract.COL_ID);
                result = this.provider.insert(PokePositionProviderAdapter.POKEPOSITION_URI, values);
        ...
        if (this.entity != null) {
            try {
                android.database.Cursor c = this.provider.query(Uri.parse(
                        ...
                        null);
                c.moveToFirst();
                result = PokePositionContract.cursorToItem(c);
                c.close();
            } catch (Exception e) {
                e.printStackTrace();
            }
    ...
    public void testReadAll() {
        ArrayList<PokePosition> result = null;
        try {
            android.database.Cursor c = this.provider.query(PokePositionProviderAdapter.POKEPOSITION_URI, this.adapter.getCols(), null, null, null);
            result = PokePositionContract.cursorToItems(c);
            c.close();
        } catch (Exception e) {
            e.printStackTrace();
        }
        ...
        if (this.entity != null) {
            ...
            try {
                ...
                result = this.provider.update(
                    Uri.parse(PokePositionProviderAdapter.POKEPOSITION_URI
                        + "/"
                        + pokePosition.getId()),
                    values,
                    null,
        ...
        if (this.entities != null) {
            if (this.entities.size() > 0) {
                ...
                try {
                    ...
                    result = this.provider.update(PokePositionProviderAdapter.POKEPOSITION_URI, values, null, null);
                } catch (Exception e) {
                    e.printStackTrace();
                }
    ...
    public void testDeleteAll() {
        ...
        if (this.entities != null) {
            if (this.entities.size() > 0) {
                ...
                try {
                    result = this.provider.delete(PokePositionProviderAdapter.POKEPOSITION_URI, null, null);
    ...
    public void testUtilsUpdate() {
        ...
        if (this.entity != null) {
            ...
            pokePosition.setId(this.entity.getId());
            result = this.providerUtils.update(pokePosition);
