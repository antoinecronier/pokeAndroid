/**************************************************************************
 * PokebattleApplicationBase.java, pokebattle Android
 *
 * Copyright 2016
 * Description : 
 * Author(s)   : Harmony
 ...
 * Harmony.
 * You should edit PokebattleApplication class instead of this
 * one or you will lose all your modifications.</i></b>
 *
 */
public abstract class PokebattleApplicationBase extends Application {

    /** TAG for debug purpose. */
    protected static final String TAG = "PokebattleApplication";
    /** Singleton. */
    private static volatile PokebattleApplicationBase singleton;
    /** Date format. */
     ...
     */
    private static void setSingleton(PokebattleApplicationBase application) {
        if (singleton == null) {
     ...
     */
    public static PokebattleApplicationBase getApplication() {
        return singleton;
    }
    ...
    public static String getVersion(final android.content.Context ctx) {
        final SharedPreferences settings = ctx.getSharedPreferences(
                PokebattleApplicationBase.PREFS_PUBL,
                android.content.Context.MODE_PRIVATE);

        return settings.getString(PokebattleApplicationBase.PREFS_VERS, "");
    }
    ...
    public static void setVersion(final android.content.Context ctx) {
        ...
        editor.putString(
            PokebattleApplicationBase.PREFS_VERS,
            currentVersion);
