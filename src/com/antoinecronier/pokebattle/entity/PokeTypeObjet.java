...
@Entity
@Rest
public class PokeTypeObjet  implements Serializable , Parcelable {
     ...
     * @param parc The parcel to read from
     */
    public PokeTypeObjet(Parcel parc) {
     ...
     * Parcelable creator.
     */
    public static final Parcelable.Creator<PokeTypeObjet> CREATOR
        = new Parcelable.Creator<PokeTypeObjet>() {
        public PokeTypeObjet createFromParcel(Parcel in) {
            return new PokeTypeObjet(in);
        }
        
        public PokeTypeObjet[] newArray(int size) {
            return new PokeTypeObjet[size];
        }
    };
