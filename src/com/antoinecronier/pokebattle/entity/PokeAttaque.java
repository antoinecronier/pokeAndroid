...
@Entity
@Rest
public class PokeAttaque  implements Serializable , Parcelable {
     ...
     */
    public void setType(final PokeType value) {
         this.type = value;
    }
    /**
    ...
    public void writeToParcelRegen(Parcel dest, int flags) {
        ...
        dest.writeInt(this.getPrecision());
    ...
    public void readFromParcel(Parcel parc) {
        ...
        this.setPrecision(parc.readInt());
        this.setType((PokeType) parc.readParcelable(PokeType.class.getClassLoader()));
    }
     ...
     * @param parc The parcel to read from
     */
    public PokeAttaque(Parcel parc) {
     ...
     * Parcelable creator.
     */
    public static final Parcelable.Creator<PokeAttaque> CREATOR
        = new Parcelable.Creator<PokeAttaque>() {
        public PokeAttaque createFromParcel(Parcel in) {
            return new PokeAttaque(in);
        }
        
        public PokeAttaque[] newArray(int size) {
            return new PokeAttaque[size];
        }
    };
