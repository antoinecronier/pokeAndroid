...
@Entity
@Rest
public class PokeObjet  implements Serializable , Parcelable {
     ...
     */
    public void setType(final PokeTypeObjet value) {
         this.type = value;
    }
    /**
    ...
    public void readFromParcel(Parcel parc) {
        ...
        this.setType((PokeTypeObjet) parc.readParcelable(PokeTypeObjet.class.getClassLoader()));
    }
     ...
     * Parcelable creator.
     */
    public static final Parcelable.Creator<PokeObjet> CREATOR
        = new Parcelable.Creator<PokeObjet>() {
        public PokeObjet createFromParcel(Parcel in) {
            return new PokeObjet(in);
        }
        
        public PokeObjet[] newArray(int size) {
            return new PokeObjet[size];
        }
    };
