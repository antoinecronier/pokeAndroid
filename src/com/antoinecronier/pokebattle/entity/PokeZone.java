...
@Entity
@Rest
public class PokeZone  implements Serializable , Parcelable {
     ...
     * Parcelable creator.
     */
    public static final Parcelable.Creator<PokeZone> CREATOR
        = new Parcelable.Creator<PokeZone>() {
        public PokeZone createFromParcel(Parcel in) {
            return new PokeZone(in);
        }
        
        public PokeZone[] newArray(int size) {
            return new PokeZone[size];
        }
    };
