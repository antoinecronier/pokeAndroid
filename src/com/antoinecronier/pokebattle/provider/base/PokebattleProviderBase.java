/**************************************************************************
 * PokebattleProviderBase.java, pokebattle Android
 *
 * Copyright 2016
 * Description : 
 * Author(s)   : Harmony
...
/**
 * PokebattleProviderBase.
 */
public class PokebattleProviderBase extends ContentProvider {
    /** TAG for debug purpose. */
    protected static String TAG = "PokebattleProvider";
    /** Uri not supported. */
    ...
    /* Tools / Common. */
    /** com.antoinecronier.pokebattle.provider authority. */
    public static String authority = "com.antoinecronier.pokebattle.provider";
    /** URI Matcher. */
    ...
    public boolean onCreate() {
        ...
        if (!PokebattleProvider.CREATE_DATABASE_DEFERRED) {
            this.loadAdapters();
        }
    ...
    public void loadAdapters() {
        ...
        PokeAreneProviderAdapter pokeAreneProviderAdapter = new PokeAreneProviderAdapter(this);
        this.db = pokeAreneProviderAdapter.getDb();
        this.providerAdapters.add(pokeAreneProviderAdapter);
        this.providerAdapters.add(new PokeBadgeProviderAdapter(this));
        this.providerAdapters.add(new PokeZoneProviderAdapter(this));
        this.providerAdapters.add(new PokeTypeProviderAdapter(this));
        this.providerAdapters.add(new PokePositionProviderAdapter(this));
        this.providerAdapters.add(new PokePokemonProviderAdapter(this));
        this.providerAdapters.add(new PokeObjetProviderAdapter(this));
        this.providerAdapters.add(new PokeAttaqueProviderAdapter(this));
        this.providerAdapters.add(new PokeDresseurProviderAdapter(this));
        this.providerAdapters.add(new PokeTypePokemonProviderAdapter(this));
        this.providerAdapters.add(new PokeTypeObjetProviderAdapter(this));
        this.providerAdapters.add(new PokeNpcProviderAdapter(this));
    ...
    public static void initializeDatabase(Context context) {
        context.getContentResolver().call(
                PokebattleProviderBase.generateUri(),
                PokebattleProviderBase.INITIALIZE_DATABASE,
                null,
                null);
    }
}
