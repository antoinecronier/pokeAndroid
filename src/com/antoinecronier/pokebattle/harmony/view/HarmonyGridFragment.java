/**************************************************************************
 * HarmonyGridFragment.java, pokebattle Android
 *
 * Copyright 2016
 * Description : 
 * Author(s)   : Harmony
...
public abstract class HarmonyGridFragment<T> extends Fragment implements LoaderManager.LoaderCallbacks<List<T>> {
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
        ...
        try {
            PokebattleMenu.getInstance(this.getActivity(), this).clear(menu);
            PokebattleMenu.getInstance(this.getActivity(), this).updateMenu(menu, this.getActivity());
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        try {
            result = PokebattleMenu.getInstance(this.getActivity(), this).dispatch(item, this.getActivity());
        } catch (Exception e) {
            e.printStackTrace();
            result = false;
        }
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        try {
            PokebattleMenu.getInstance(this.getActivity(), this)
