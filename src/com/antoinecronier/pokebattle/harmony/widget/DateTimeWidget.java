/**************************************************************************
 * DateTimeWidget.java, pokebattle Android
 *
 * Copyright 2016
 * Description : 
 * Author(s)   : Harmony
 ...
 *
 **************************************************************************/
package com.antoinecronier.pokebattle.harmony.widget;
...
import com.antoinecronier.pokebattle.harmony.util.DateUtils.TimeFormatType;
        ...
        switch (arg0.getId()) {
            ...
            case R.id.time:
                ...
                if (this.timeFormat.equals(TimeFormatType.AMPM)) {
                    ...
                    format24H = PokebattleApplication.is24Hour();
                }
