/**************************************************************************
 * PokebattleMenu.java, pokebattle Android
 *
 * Copyright 2016
 * Description : 
 * Author(s)   : Harmony
 ...
 *
 **************************************************************************/
package com.antoinecronier.pokebattle.menu;


import android.support.v4.app.Fragment;

import com.antoinecronier.pokebattle.menu.base.PokebattleMenuBase;
 ...
 */
public class PokebattleMenu
                extends PokebattleMenuBase {

    /** Singleton unique instance. */
    private static volatile PokebattleMenu singleton;
     ...
     */
    public PokebattleMenu(final android.content.Context ctx) throws Exception {
        super(ctx);
    }
     ...
     * @throws Exception If something bad happened
     */
    public PokebattleMenu(final android.content.Context ctx,
    ...
    /** Get unique instance.
     * @param ctx The context
     * @return PokebattleMenu instance
     * @throws Exception If something bad happened
     */
    public static final synchronized PokebattleMenu getInstance(
    ...
    public static final synchronized PokebattleMenu getInstance(
        ...
        if (singleton == null) {
            singleton = new PokebattleMenu(ctx, fragment);
        }  else {
            singleton.ctx = ctx;
