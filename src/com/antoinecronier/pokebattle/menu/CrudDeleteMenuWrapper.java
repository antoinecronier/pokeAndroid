/**************************************************************************
 * CrudDeleteMenuWrapper.java, pokebattle Android
 *
 * Copyright 2016
 * Description : 
 * Author(s)   : Harmony
...
import com.antoinecronier.pokebattle.menu.base.MenuWrapperBase;
...
public class CrudDeleteMenuWrapper implements MenuWrapperBase {
    ...
    public void updateMenu(Menu menu, FragmentActivity activity,
        ...
        if ((fragment != null 
            ...
            menu.setGroupVisible(
                    PokebattleMenu.CRUDDELETE, this.visible);
        }
    }
    ...
    public void clear(Menu menu, FragmentActivity activity,
        ...
        if (fragment != null 
                && fragment instanceof CrudDeleteMenuInterface) {
            menu.removeGroup(PokebattleMenu.CRUDDELETE);
        }
    }
