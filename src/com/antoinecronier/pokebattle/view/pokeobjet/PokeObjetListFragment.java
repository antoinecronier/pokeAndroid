/**************************************************************************
 * PokeObjetListFragment.java, pokebattle Android
 *
 * Copyright 2016
 * Description : 
 * Author(s)   : Harmony
...
/** PokeObjet list fragment.
 *
 * This fragment gives you an interface to list all your PokeObjets.
 *
 * @see android.app.Fragment
 */
public class PokeObjetListFragment
        extends HarmonyListFragment<PokeObjet>
        implements CrudCreateMenuInterface {

    /** The adapter which handles list population. */
    protected PokeObjetListAdapter mAdapter;
    ...
    public View onCreateView(
        ...
        final View view =
                inflater.inflate(R.layout.fragment_pokeobjet_list,
                        null);

        this.initializeHackCustomList(view,
                R.id.pokeobjetProgressLayout,
                R.id.pokeobjetListContainer);
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        this.setEmptyText(this.getString(
                R.string.pokeobjet_empty_list));

        // Create an empty adapter we will use to display the loaded data.
        this.mAdapter = new PokeObjetListAdapter(this.getActivity(), null);
    ...
    public Loader<android.database.Cursor> onCreateLoader(int id, Bundle bundle) {
        ...
        if (crit != null) {
            result = new PokeObjetListLoader(this.getActivity(),
