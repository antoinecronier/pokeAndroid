/**************************************************************************
 * PokeAttaqueListFragment.java, pokebattle Android
 *
 * Copyright 2016
 * Description : 
 * Author(s)   : Harmony
...
/** PokeAttaque list fragment.
 *
 * This fragment gives you an interface to list all your PokeAttaques.
 *
 * @see android.app.Fragment
 */
public class PokeAttaqueListFragment
        extends HarmonyListFragment<PokeAttaque>
        implements CrudCreateMenuInterface {

    /** The adapter which handles list population. */
    protected PokeAttaqueListAdapter mAdapter;
    ...
    public View onCreateView(
        ...
        final View view =
                inflater.inflate(R.layout.fragment_pokeattaque_list,
                        null);

        this.initializeHackCustomList(view,
                R.id.pokeattaqueProgressLayout,
                R.id.pokeattaqueListContainer);
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        this.setEmptyText(this.getString(
                R.string.pokeattaque_empty_list));

        // Create an empty adapter we will use to display the loaded data.
        this.mAdapter = new PokeAttaqueListAdapter(this.getActivity(), null);
    ...
    public Loader<android.database.Cursor> onCreateLoader(int id, Bundle bundle) {
        ...
        if (crit != null) {
            result = new PokeAttaqueListLoader(this.getActivity(),
    ...
    public void onClickAdd() {
        Intent intent = new Intent(this.getActivity(),
                    PokeAttaqueCreateActivity.class);
