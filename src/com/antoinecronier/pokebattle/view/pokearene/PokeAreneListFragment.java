/**************************************************************************
 * PokeAreneListFragment.java, pokebattle Android
 *
 * Copyright 2016
 * Description : 
 * Author(s)   : Harmony
...
/** PokeArene list fragment.
 *
 * This fragment gives you an interface to list all your PokeArenes.
 *
 * @see android.app.Fragment
 */
public class PokeAreneListFragment
        extends HarmonyListFragment<PokeArene>
        implements CrudCreateMenuInterface {

    /** The adapter which handles list population. */
    protected PokeAreneListAdapter mAdapter;
    ...
    public View onCreateView(
        ...
        final View view =
                inflater.inflate(R.layout.fragment_pokearene_list,
                        null);

        this.initializeHackCustomList(view,
                R.id.pokeareneProgressLayout,
                R.id.pokeareneListContainer);
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        this.setEmptyText(this.getString(
                R.string.pokearene_empty_list));

        // Create an empty adapter we will use to display the loaded data.
        this.mAdapter = new PokeAreneListAdapter(this.getActivity(), null);
    ...
    public Loader<android.database.Cursor> onCreateLoader(int id, Bundle bundle) {
        ...
        if (crit != null) {
            result = new PokeAreneListLoader(this.getActivity(),
