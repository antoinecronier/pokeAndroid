/**************************************************************************
 * PokeBadgeListFragment.java, pokebattle Android
 *
 * Copyright 2016
 * Description : 
 * Author(s)   : Harmony
...
/** PokeBadge list fragment.
 *
 * This fragment gives you an interface to list all your PokeBadges.
 *
 * @see android.app.Fragment
 */
public class PokeBadgeListFragment
        extends HarmonyListFragment<PokeBadge>
        implements CrudCreateMenuInterface {

    /** The adapter which handles list population. */
    protected PokeBadgeListAdapter mAdapter;
    ...
    public View onCreateView(
        ...
        final View view =
                inflater.inflate(R.layout.fragment_pokebadge_list,
                        null);

        this.initializeHackCustomList(view,
                R.id.pokebadgeProgressLayout,
                R.id.pokebadgeListContainer);
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        this.setEmptyText(this.getString(
                R.string.pokebadge_empty_list));

        // Create an empty adapter we will use to display the loaded data.
        this.mAdapter = new PokeBadgeListAdapter(this.getActivity(), null);
    ...
    public Loader<android.database.Cursor> onCreateLoader(int id, Bundle bundle) {
        ...
        if (crit != null) {
            result = new PokeBadgeListLoader(this.getActivity(),
