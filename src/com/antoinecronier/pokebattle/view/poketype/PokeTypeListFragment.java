/**************************************************************************
 * PokeTypeListFragment.java, pokebattle Android
 *
 * Copyright 2016
 * Description : 
 * Author(s)   : Harmony
...
/** PokeType list fragment.
 *
 * This fragment gives you an interface to list all your PokeTypes.
 *
 * @see android.app.Fragment
 */
public class PokeTypeListFragment
        extends HarmonyListFragment<PokeType>
        implements CrudCreateMenuInterface {

    /** The adapter which handles list population. */
    protected PokeTypeListAdapter mAdapter;
    ...
    public View onCreateView(
        ...
        final View view =
                inflater.inflate(R.layout.fragment_poketype_list,
                        null);

        this.initializeHackCustomList(view,
                R.id.poketypeProgressLayout,
                R.id.poketypeListContainer);
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        this.setEmptyText(this.getString(
                R.string.poketype_empty_list));

        // Create an empty adapter we will use to display the loaded data.
        this.mAdapter = new PokeTypeListAdapter(this.getActivity(), null);
    ...
    public Loader<android.database.Cursor> onCreateLoader(int id, Bundle bundle) {
        ...
        if (crit != null) {
            result = new PokeTypeListLoader(this.getActivity(),
