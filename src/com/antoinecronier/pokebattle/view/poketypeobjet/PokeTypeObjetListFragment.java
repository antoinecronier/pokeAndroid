/**************************************************************************
 * PokeTypeObjetListFragment.java, pokebattle Android
 *
 * Copyright 2016
 * Description : 
 * Author(s)   : Harmony
...
/** PokeTypeObjet list fragment.
 *
 * This fragment gives you an interface to list all your PokeTypeObjets.
 *
 * @see android.app.Fragment
 */
public class PokeTypeObjetListFragment
        extends HarmonyListFragment<PokeTypeObjet>
        implements CrudCreateMenuInterface {

    /** The adapter which handles list population. */
    protected PokeTypeObjetListAdapter mAdapter;
    ...
    public View onCreateView(
        ...
        final View view =
                inflater.inflate(R.layout.fragment_poketypeobjet_list,
                        null);

        this.initializeHackCustomList(view,
                R.id.poketypeobjetProgressLayout,
                R.id.poketypeobjetListContainer);
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        this.setEmptyText(this.getString(
                R.string.poketypeobjet_empty_list));

        // Create an empty adapter we will use to display the loaded data.
        this.mAdapter = new PokeTypeObjetListAdapter(this.getActivity(), null);
    ...
    public Loader<android.database.Cursor> onCreateLoader(int id, Bundle bundle) {
        ...
        if (crit != null) {
            result = new PokeTypeObjetListLoader(this.getActivity(),
    ...
    public void onClickAdd() {
        Intent intent = new Intent(this.getActivity(),
                    PokeTypeObjetCreateActivity.class);
