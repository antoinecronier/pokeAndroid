/**************************************************************************
 * PokeZoneShowFragment.java, pokebattle Android
 *
 * Copyright 2016
 * Description : 
 * Author(s)   : Harmony
...
/** PokeZone show fragment.
 *
 * This fragment gives you an interface to show a PokeZone.
 * 
 * @see android.app.Fragment
 */
public class PokeZoneShowFragment
    ...
    public View onCreateView(
        ...
        final View view =
                inflater.inflate(
                        R.layout.fragment_pokezone_show,
                        container,
                        false);  
        ...
        this.update((PokeZone) intent.getParcelableExtra(PokeZoneContract.PARCEL));
     ...
     *
     * @param item The PokeZone to get the data from.
     */
    public void update(PokeZone item) {
        this.model = item;
        ...
        if (this.model != null) {
            ...
            loader.addUri(Uri.parse(baseUri), new UriLoadedCallback() {
                ...
                public void onLoadComplete(android.database.Cursor c) {
                    PokeZoneShowFragment.this.onPokeZoneLoaded(c);
                }
     ...
     */
    public void onPokeZoneLoaded(android.database.Cursor c) {
        if (c.getCount() > 0) {
            c.moveToFirst();
            
            PokeZoneContract.cursorToItem(
                        c,
                        this.model);
            this.loadData();
        }
    ...
    /**
     * Calls the PokeZoneEditActivity.
     */
    @Override
    public void onClickEdit() {
        final Intent intent = new Intent(getActivity(),
                                    PokeZoneEditActivity.class);
        Bundle extras = new Bundle();
        extras.putParcelable(PokeZoneContract.PARCEL, this.model);
    ...
    private class DeleteTask extends AsyncTask<Void, Void, Integer> {
        ...
        /** Entity to delete. */
        private PokeZone item;

        /**
         * Constructor of the task.
         * @param item The entity to remove from DB
         * @param ctx A context to build PokeZoneSQLiteAdapter
         */
        ...
        protected Integer doInBackground(Void... params) {
            ...
            result = new PokeZoneProviderUtils(this.ctx)
                    .delete(this.item);
        ...
        protected void onPostExecute(Integer result) {
            if (result >= 0) {
                PokeZoneShowFragment.this.onPostDelete();
            }
