/**************************************************************************
 * SQLiteAdapterBase.java, pokebattle Android
 *
 * Copyright 2016
 * Description : 
 * Author(s)   : Harmony
...
public abstract class SQLiteAdapterBase<T> {
    ...
    public static final String TAG = "PokebattleSQLiteAdapterBase";
     ...
     * Open Helper.
     */
    protected PokebattleSQLiteOpenHelper mBaseHelper;
    ...
    protected SQLiteAdapterBase(final android.content.Context ctx) {
        this.ctx = ctx;
        this.mBaseHelper = new PokebattleSQLiteOpenHelper(
                ctx,
                DB_NAME,
                null,
                PokebattleApplication.getVersionCode(ctx));
